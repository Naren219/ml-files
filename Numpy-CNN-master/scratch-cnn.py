...
# Convolving the image by the filter(s).
    for filter_color in range(conv_filter.shape[3]):
        for filter_num in filter_color:
            print("Filter ", filter_num + 1)
            curr_filter = conv_filter[filter_num, :, :, filter_color] # getting a filter from the bank.
            """ 
